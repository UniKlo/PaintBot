...
E. | Wooden Bracket <br/> <img src="https://github.com/UniKlo/PaintBot/blob/master/img_gif/safety%20brackets.jpg" height="300px"/>| Device that is designed to handle forces from the tension in the chain system by holding the chain in place during operations <br/> [Design Goals, Force Diagrams, CAD Drawings/Documents]() <br/> [How to Assemble]()
